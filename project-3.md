...
- Step 1: Run Mininet emulator
  ...
  You should be able to see something like this:
   ...
   Keep this terminal open, as you will need the mininet command line
   for debugging.
...
- IP
- ICMP
- ARP For the actual specifications, there are also the RFC's for ARP
(RFC826), IP (RFC791), and ICMP (RFC792).
...
- print_addr\_ip\_int(uint32\_t ip) - Prints out a formatted IP address from a uint32_t. Make sure you are passing the IP address in the correct byte ordering.
